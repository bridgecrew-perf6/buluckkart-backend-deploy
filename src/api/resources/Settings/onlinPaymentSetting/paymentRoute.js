...
paymentSettingRoute.route('/getby/:id').get(sanitize(), paymentCtrl.getpaymentGatewaySettings);
paymentSettingRoute.route('/delete/:id').delete(sanitize(), paymentCtrl.deletepaymentGatewaySettings);
paymentSettingRoute.route('/update/:id').put(sanitize(), paymentCtrl.updatepaymentGatewaySettings);
