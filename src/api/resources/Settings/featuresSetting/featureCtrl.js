...
async getfeatureSettings(req, res) {
    try {
        const featureSettingsDetails = await db.featureSettings.findOne({ where: { id: req.params.id } });
        res.status(200).send({
            status: 200,
