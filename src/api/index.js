...
import { dynamicTexRoute} from'./resources/Settings/TaxSetting/dynamicTax';
import { staticTaxRouter } from'./resources/Settings/TaxSetting/staticTax';
...
restRouter.use('/dynamictax',dynamicTexRoute)
restRouter.use('/statictax',staticTaxRouter)
